...
export default class CargaIndicadores extends Component  {
  ...
  render() {
    ...
    const indicadores = [{ id: 0, nombre: "Indicador X", expresion: "x+1000" },
                         { id: 0, nombre: "Indicador Y", expresion: "x+1000" }];

    const cuentas = [{ id: 0, nombre: "Cuenta X", periodo: "Q1", valor: "32000" },
                      { id: 0, nombre: "Cuenta Y", periodo: "Q2", valor: "876000" }];
